...
mod tests {
    use super::{
        ...
        validate_generated_appcast, write_atomically, AltoolPrivateKey, AppPreviewState,
        AppcastBuildNumber, AppcastDownloadLocation, AppcastRelease, AppcastState,
        AppcastStateUpdate, MetadataImportRetry, ReleaseTarget, MAX_METADATA_IMPORT_RETRIES,
    };
