...
pub mod test_support {
    ...
    pub struct SearchTestHooks {
        pub before_eager_matches: Option<Arc<dyn Fn() + Send + Sync>>,
        pub on_eager_match: Option<Arc<dyn Fn(usize) + Send + Sync>>,
        pub on_analysis_cache_hit: Option<Arc<dyn Fn(i64, String) + Send + Sync>>,
        pub on_analysis_computed: Option<Arc<dyn Fn(i64, String) + Send + Sync>>,
    }
    ...
    pub fn on_eager_match(index: usize) {
    ...
    pub fn on_analysis_cache_hit(item_id: i64, query: &str) {
    ...
    pub fn on_analysis_computed(item_id: i64, query: &str) {
...
#[derive(Default)]
pub struct HighlightAnalysisCache {
