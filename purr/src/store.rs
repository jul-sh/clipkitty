...
use crate::interface::{
    ...
    SearchResult, StoreBootstrapPlan, TransferFetchOutcome,
};
#[cfg(feature = "sync")]
...
mod tests {
    ...
    fn bounded_transfer_fetch_is_ordered_and_rejects_partial_requests() {
        ...
        let outcome = store
            ...
            .unwrap();
        let TransferFetchOutcome::Success { items } = outcome else {
