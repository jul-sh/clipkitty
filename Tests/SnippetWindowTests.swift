...
/// Tests for the 30/70 snippet windowing logic implemented in ContentView.swift
...
struct SnippetWindowTests {
    ...
    private func calculateWindow(
        ...
        // Match-centered logic with 30/70 split
    ...
    @Test("Match in middle is centered with 30/70 split")
    func testMatchCentering() {
        ...
        // Should be around 0.3 (allowing some margin for rounding and prefix adjustment)
        #expect(ratio > 0.25 && ratio < 0.35)
    }
